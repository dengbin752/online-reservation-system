...
`;
		try {
			...
			if ((error as ApolloError).networkError! && 'statusCode' in (error as ApolloError).networkError! ) {
				if ((error as ApolloError).networkError!.statusCode! === 403) {
					// token expired
					setTimeout(() => navigate("/logreg"), 0);
					return
				}
		...
		<div class="p-8 space-y-8">
			...
			<div class="mt-12 text-center">
				...
				<p class="text-gray-500 mb-6">
					Manage your existing reservations below.
				</p>
				<div class="space-y-4">
						...
						<div class="bg-gray-50 p-6 rounded-lg shadow-md flex justify-between items-center transition hover:shadow-lg border border-gray-100">
							<div>
								...
								<p class="text-sm text-gray-600">
									{reservation.date.substr(0, 10)} at {reservation.time} for{" "}
